...
class DatabaseSeeder extends Seeder
{
    ...
    {
        // Admin kasutaja — firstOrCreate prevents duplicate errors on re-deploy
        ...
        // Demo blogipostitused — only seed if none exist yet
        ...
        // Demo markerid — only seed if none exist yet
        if (Marker::count() === 0) {
            $markers = [
        ...
        // Demo filmid — only seed if none exist yet
        if (Film::count() === 0) {
            $films = [
